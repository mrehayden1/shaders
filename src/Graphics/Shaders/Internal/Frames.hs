...
createFrames :: (MonadAsyncException m, MonadLogger m, MonadResource m)
...
createSyncObjects :: (MonadAsyncException m, MonadLogger m, MonadResource m)
  => Maybe AllocationCallbacks
  -> Device
  -> Int
...
createCommandBuffers :: (MonadAsyncException m, MonadLogger m, MonadResource m)
  => Device
  -> Int
